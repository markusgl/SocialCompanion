"""
Based on Telegram channel with additional speech output
"""
...
class TelegramCustomOutput(Bot, OutputChannel):
    ...
    def __init__(self, access_token):
        super(TelegramCustomOutput, self).__init__(access_token)
        self.tts = GoogleTTS()

    def send_text_message(self, recipient_id, message):
        self.send_message(recipient_id, message)
        return self.tts.utter_voice_message(message)  # voice output
    ...
    def send_text_with_buttons(self, recipient_id, text,
        ...
        return self.tts.utter_voice_message(text)  # voice output


class TelegramCustomInput(HttpInputComponent):
    ...
    def blueprint(self, on_new_message):
        ...
        out_channel = TelegramCustomOutput(self.access_token)
